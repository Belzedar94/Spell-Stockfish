...
- On the **casting ply**, the caster's own base move may not originate from inside the
  **new** zone's block area (you cast before moving; your own piece inside the fresh zone is stuck
  that ply). The base move may also not originate from the gate square itself.
...
**Known historical divergence**: earlier private builds of the reference line recorded
`d1 = 1814, d2 = 3007820`. The public branch (our frozen baseline) yields `1878 / 3287752`
(64 more root moves = one additional freeze-gated base move per gate). We target the **public**
baseline numbers.
