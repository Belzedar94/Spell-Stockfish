...
//
// Both are search policy, not rules: this runs on the QUIETS stage, which
// already limits gates, and — since 2c0183b2 — on the gated CAPTURES, which
// the guard below therefore covers as well. The legal universe (perft, UCI
// validation, evasions) never sees it.
//
