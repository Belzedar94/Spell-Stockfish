...
//   middlegames and 70% in endgames go to gates whose every gated move
//   is_useless_spell then throws away. A floor of 5000 is already 2x a queen,
//   so SPSA cannot currently express "this bonus should be small". Note the
//   knob only reorders: the ringCount override in movegen.cpp is geometric
//   and admits those gates regardless of the bonus.
