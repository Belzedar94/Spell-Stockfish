...
// Structural pillar D: volatility-scaled selectivity (off by default)
int SpellVolatilityLmr      = 0;
int SpellVolatilityFutility = 0;
...
TUNE(SetRange(0, 1024), SpellVolatilityLmr);
TUNE(SetRange(0, 120), SpellVolatilityFutility);
