...
| S6 | Protocolos y bindings: XBoard/CECP ✅ endurecido · notation.{h,cpp} ✅ (cierre reglas-only de 10 TUs sin threads/TT/NNUE) · **pyffish_spell ✅** (39 checks + paridad vs motor) · **ffish-spell.js ✅** (WASM embind CJS+ESM, 30+4 checks) · wheels CI (cibuildwheel, manual/tags) — pendiente: publicación PyPI/npm, smoke con pychess/Fairyground, WASM motor-completo (fuera de alcance S6), SAN spell-aware (fase 2) | 🔶→✅ núcleo |
