...
| 2026-07-13 | Spell-Stockfish @ 53df2708 PGO g++15.2 (BROKEN) | `bench 16 1 10 default depth` (run5rl) | 2,395,529 | 135,486 | profile-build under g++ 15.2 is 3.3x SLOWER than plain build, same tree. DO NOT USE. |
| 2026-07-13 | Spell-Stockfish @ 53df2708 plain build g++15.2 (OFFICIAL) | `bench 16 1 10 default depth` (run5rl) | 2,395,529 | 415,457 | New official recipe: `make -j build ARCH=x86-64-bmi2 COMP=mingw` (no PGO). +4.5% over the g++11 PGO 397,770. Suite 6/6. |
